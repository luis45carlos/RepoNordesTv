...
def clearCache():
    ...
    xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('KelTecMP-Maintenance' , 'Limpeza Automatica Concluida' , '3000', iconpath))    
...
def deleteThumbnails():
    ...
    try:
		...
		pass
    dialog.ok("Reinicie o Kodi", "Por favor, Reinicie o Kodi para reconstruir a biblioteca de miniaturas")
